      ...
      <div className="container">
        <div className={styles.main}>
          ...
          <ul className={styles.categories}>
            <li>
              <NavLink activeClassName={styles.active} to="/about-us">Про нас</NavLink>
            </li>
            <li>
              <NavLink activeClassName={styles.active} to="/women">Для девушек</NavLink>
            </li>
            <li>
              <NavLink activeClassName={styles.active} to="/men">Для мужчин</NavLink>
            </li>
            ...
            <li>
              <NavLink activeClassName={styles.active} to="/sales">Распродажа</NavLink>
            </li>
            <li>
              <NavLink activeClassName={styles.active} to="/blog">Блог</NavLink>
            </li>
            <li>
          ...
          <ul className={styles.user}>
            ...
            {!!items
              ?
              <li data-cart={items} className={styles.cart}><NavLink activeClassName={styles.active} to="/cart"><Bag /></NavLink>
              </li>
              : <li><NavLink activeClassName={styles.active} to="/cart"><Bag /></NavLink></li>
            }
            {!!favorite
              ? <li data-cart={favorite} className={styles.cart}><NavLink activeClassName={styles.active}
                                                                          to="/favorite"><Like /></NavLink></li>
