...
const Buttons = ({setFilter, isGrid, changeToLineHandler, changeToGridHandler, setPrice, sortPrice}) => {
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.fromTo}>
        <p onClick={setPrice}>Цена <i className={sortPrice ? "fas fa-arrow-up sort_icon" : "fas fa-arrow-up"}></i></p>
      </div>
    </div>
  );
};
